    ...
    <section id = "main">
        <section id ="text">
            ...
            <main>
                ...
                <?php
                $zapytanie=mysqli_query($conn,"SELECT DISTINCT data_ur,miot,rasa from swinki join rasy on swinki.rasy_id=rasy.id where swinki.rasy_id=1;");
                ...
                <?php
                    $zapytanie=mysqli_query($conn,"select imie, cena,opis from swinki where rasy_id = 1;");
                    while($row=$zapytanie->fetch_assoc()){
                        $imie=$row['imie'];
                        $cena=$row['cena'];
                        $opis=$row['opis'];
